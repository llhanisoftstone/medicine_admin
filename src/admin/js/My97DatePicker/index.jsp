...
<input class="Wdate" type="text" onClick="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM-dd HH:mm:ss'})" readonly="readonly"> <font color=red>&lt;- 点我弹出日期控件</font>


<br><br><br><br>
${request.pageContext.contextPath}
更多demo请访问官方主页 <a href="http://www.my97.net">http://www.my97.net</a>

<br><br>
<h1>请务必仔细阅读下面的文字</h1><br>
<pre>
注意:此版本为 4.8 Release build 20110824
