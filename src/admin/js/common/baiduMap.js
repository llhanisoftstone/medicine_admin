...
// 百度地图API功能
	...
	function createMap(cityName){
		...
		$("#searchBtn").bind("click",function(){
			local.search($("#city_name").find("option:selected").text()+$("#city_name_2").find("option:selected").text()+$("#city").val());
            setTimeout(function(){
		...
		if(addressId != "" && addressId != undefined){
			myValue = $("#city_name").find("option:selected").text()+$("#city_name_2").find("option:selected").text()+$("#city").val();
//			setPlace();
