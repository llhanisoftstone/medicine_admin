...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tActions = '<div class="file-actions">\n' +
            ...
            '        {upload}{delete}{other}' +
            '    </div>\n' +
            '<span style="margin-left: 20px;">显示顺序：</span><input class="order_code"  type="text" style="margin-right:20px; "/>' +
            '    <div class="clearfix"></div>\n' +
            '</div>',
    ...
    FileInput.prototype = {
        ...
        getOutData: function (jqXHR, responseData, filesData) {
            ...
            console.log('111111');
            console.log(self.filestack.slice(0))
        ...
        upload: function () {
            ...
            if (self.uploadAsync && self.showPreview) {
                outData = self.getOutData();//获取图片集合
                console.log(outData);
